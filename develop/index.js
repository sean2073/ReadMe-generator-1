...
const questions = [{
    ...
    message: 'What are the steps needed to install the project? (Required)',
       validate: installationInput => {
          ...
          console.log('Please enter you instructions for installation!');
          return false;
          }
       }
    },
    ...
    type: 'input',
    name: 'credits',
    message: 'List any collaborators and/or link any tutorials that you used or type none. (Required)',
       validate: creditsInput => {
          if (creditsInput) {
          return true;
          } else {
          console.log('Please enter credits or type none!');
          return false;
          }
       }
    },
    ...
    message: 'Provide an example of how to run the application. (Required)',
       validate: testInput => {
          ...
          console.log('Please enter an example on how to run the app!');
          return false;
          }
       }
    },
